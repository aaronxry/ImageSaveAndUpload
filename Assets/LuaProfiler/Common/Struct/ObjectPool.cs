...
{
    public class LPObjectPool<T> where T : class, new()
    {
        ...
        public LPObjectPool(int poolSize, CreateFunc createFunc = null, Action<T> resetAction = null)
        {
