...
namespace MikuLuaProfiler
{
    ...
    {
        private static LPObjectPool<LuaProfilerTreeViewItem> objectPool = new LPObjectPool<LuaProfilerTreeViewItem>(30);
    ...
    public class LuaProfilerTreeView : TreeView
    {
            ...
            : base(treeViewState, CreateDefaultMultiColumnHeaderState(width))
        {
            ...
            //LPNetWorkClient.ConnectServer("127.0.0.1", 23333);

            //LPLuaProfiler.SetSampleEnd(LoadRootSample);
