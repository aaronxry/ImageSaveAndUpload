...
namespace MikuLuaProfiler
{
    ...
    public class LuaRefInfo : NetBase
    {
        ...
        #region pool
        private static LPObjectPool<LuaRefInfo> m_pool = new LPObjectPool<LuaRefInfo>(32);
    ...
    public class LuaDiffInfo : NetBase
    {
        ...
        #region pool
        private static LPObjectPool<LuaDiffInfo> m_pool = new LPObjectPool<LuaDiffInfo>(32);
    ...
    public class Sample : NetBase
    {
        ...
        private static LPObjectPool<Sample> samplePool = new LPObjectPool<Sample>(4096);
