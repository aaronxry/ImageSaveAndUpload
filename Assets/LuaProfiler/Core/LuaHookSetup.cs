...
namespace MikuLuaProfiler
{
    ...
    public class HookLuaSetup : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            {
                SampleData.pss = LPNativeHelper.GetPass();
                SampleData.power = LPNativeHelper.GetBatteryLevel();
                currentTime = Time.unscaledTime;
            }
            LPLuaProfiler.SendFrameSample();
    ...
    public class MikuLuaProfilerLuaProfilerWrap
    {
        ...
        {
            LuaDLL.lua_newtable(L);
            LuaDLL.lua_pushstring(L, "LPLuaProfiler");
            LuaDLL.lua_newtable(L);
...
function miku_diff(record, staticRecord)
    ...
    return add,remain,null_list
        ...
        {
            LPLuaProfiler.BeginSample(L, LPLuaHook.GetRefString(L, 1));
            return 0;
        }
        ...
        static int AddRefFunInfo(IntPtr L)
        {
            ...
            LPLuaProfiler.AddRef(funName, funAddr, type);
            return 0;
        }
