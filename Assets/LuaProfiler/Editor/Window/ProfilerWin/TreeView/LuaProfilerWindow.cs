...
namespace MikuLuaProfiler
{
    ...
    public class LuaProfilerWindow : EditorWindow
    {
        ...
        private void OpenLocalMode()
        {
            ...
            LPLuaProfiler.UnRegistReceive();
            NetWorkServer.UnRegisterReceive();
            LPLuaProfiler.RegisterOnReceiveSample(m_TreeView.LoadRootSample);
            LPLuaProfiler.RegisterOnReceiveRefInfo(m_luaRefScrollView.DelRefInfo);
            LPLuaProfiler.RegisterOnReceiveDiffInfo(m_luaDiffScrollView.DelDiffInfo);
        }
